...
public class Inventory {
	...
	public Inventory() {
		HpItem smallPotion = new HpItem("Small Potion", 1, 20, "resources/smallPotion.png","Restore 20 HP");
		HpItem mediumPotion = new HpItem("Medium Potion", 1, 50, "resources/mediumPotion.png", "Restore 50 HP");
		ManaItem smallMana = new ManaItem("Small Mana Potion",1, 20,"resources/smallMana.png", "Restore 20 mana");
